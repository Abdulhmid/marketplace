...
class ConfigurationsController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = Configurations::latest()->get();
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                           ...
                           $editUrl = url('configurations/'.$row->id);
        ...
        return view('modules.configurations.index');
    }
    ...
    {
        return view('modules.configurations.form');
    }
    ...
    public function store(Request $request)
    {
        ...
        if (isset($isEdit)) {
            ...
            Configurations::whereId($isEdit)->update($rulesData);
            $this->meesage('message','Configurations updated successfully!');
    ...
    )
    {
        ...
        $this->meesage('message','Configurations deleted successfully!');
