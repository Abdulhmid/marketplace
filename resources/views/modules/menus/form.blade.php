                    ...
                    <div class="col-md-12">
                      <form action="{{ route('menus.store') }}" method="post">
                        ...
                        <div class="form-group">
                          <label for="name">Name Menus</label>
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="name">Url Menus</label>
                          <input type="label" class="form-control" required="" name="url" aria-describedby="name" value="{{isset($row)?$row->url:''}}" placeholder="Enter URL">
                        </div>
                        <div class="form-group">
                          <label for="name">Sort Menus</label>
                          <input type="label" class="form-control" required="" name="sort" aria-describedby="name" value="{{isset($row)?$row->sort:''}}" placeholder="Enter Sorting">
                        </div>
                        <div class="form-group">
                        ...
                        <a href="{{url('menus')}}" class="edit btn btn-default">Back</a> 
                      </form>
                    </div>
                </div>
              </div>
