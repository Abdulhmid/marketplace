                ...
                <div class="row">
                    <div class="col-md-12">
                      <form action="{{ route('payments.store') }}" method="post">
                        ...
                        <div class="form-group">
                          <label for="name">Label Payments</label>
                          <input type="label" class="form-control" required="" name="label" aria-describedby="name" value="{{isset($row)?$row->label:''}}" placeholder="Enter label">
                        </div>
                        <div class="form-group">
                        ...
                        <a href="{{url('payments')}}" class="edit btn btn-default">Back</a> 
                      </form>
                    </div>
                </div>
              </div>
