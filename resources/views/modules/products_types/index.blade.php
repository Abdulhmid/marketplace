...
<h1>Master Data Products Types</h1>
@stop
            ...
            <div class="">
              <div class="card-header">
                    ...
                    <div class="card-header-right">
                        <a href="{{url('products-types/create')}}" class="btn btn-info btn-round"><i class="icofont icofont-ui-add" style="color: #fff;"></i> Add Products Types</a>
                    </div>
              </div>
              <div class="card-body">
                <div class="row">
...
<script>
    ...
    $('body').on('click', '.deleteAction', function () {
        ...
        if(confirm("Are You sure want to delete !"))
        {
          $.ajax({
              type: "get",
              url: "{{ url('products-types-delete') }}"+'/'+id,
