                  ...
                  <div class="header__actions"><a href="#">Login & Regiser</a>
                    <div class="btn-group ps-dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">USD<i class="fa fa-angle-down"></i></a>
                      <ul class="dropdown-menu">
                        <li><a href="#"><img src="{{url('marketplace')}}/images/flag/usa.svg" alt=""> USD</a></li>
                        <li><a href="#"><img src="{{url('marketplace')}}/images/flag/singapore.svg" alt=""> SGD</a></li>
                        <li><a href="#"><img src="{{url('marketplace')}}/images/flag/japan.svg" alt=""> JPN</a></li>
                      </ul>
                    </div>
      ...
      <nav class="navigation">
        <div class="container-fluid">
          <div class="navigation__column left">
            <div class="header__logo"><a class="ps-logo" href="index.html"><img src="{{url('marketplace')}}/images/logo.png" alt=""></a></div>
          </div>
    ...
    <main class="ps-main">
      <div class="ps-banner">
        <div class="rev_slider fullscreenbanner" id="home-banner">
          <ul>
            <li class="ps-banner" data-index="rs-2972" data-transition="random" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg" src="{{url('marketplace')}}/images/slider/3.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina>
            ...
            <li class="ps-banner ps-banner--white" data-index="rs-100" data-transition="random" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg" src="{{url('marketplace')}}/images/slider/2.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina>
            ...
            <div class="masonry-wrapper" data-col-md="4" data-col-sm="2" data-col-xs="1" data-gap="30" data-radio="100%">
              <div class="ps-masonry">
                  ...
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail">
                        ...
                        <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{url('marketplace')}}/images/shoe/1.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{url('marketplace')}}/images/shoe/2.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/3.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/4.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/5.jpg" alt=""></div>
                ...
                <div class="grid-item nike">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{url('marketplace')}}/images/shoe/2.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{url('marketplace')}}/images/shoe/2.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/3.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/4.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/5.jpg" alt=""></div>
                ...
                <div class="grid-item adidas">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{url('marketplace')}}/images/shoe/3.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{url('marketplace')}}/images/shoe/2.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/3.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/4.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/5.jpg" alt=""></div>
                ...
                <div class="grid-item kids">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail">
                        <div class="ps-badge ps-badge--sale"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{url('marketplace')}}/images/shoe/4.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{url('marketplace')}}/images/shoe/2.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/3.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/4.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/5.jpg" alt=""></div>
                ...
                <div class="grid-item men">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{url('marketplace')}}/images/shoe/5.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{url('marketplace')}}/images/shoe/2.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/3.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/4.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/5.jpg" alt=""></div>
                ...
                <div class="grid-item women">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{url('marketplace')}}/images/shoe/6.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{url('marketplace')}}/images/shoe/2.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/3.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/4.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/5.jpg" alt=""></div>
                ...
                <div class="grid-item kids">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{url('marketplace')}}/{{url('marketplace')}}/images/shoe/7.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{url('marketplace')}}/images/shoe/2.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/3.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/4.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/5.jpg" alt=""></div>
                ...
                <div class="grid-item kids">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{url('marketplace')}}/images/shoe/8.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{url('marketplace')}}/images/shoe/2.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/3.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/4.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/5.jpg" alt=""></div>
      ...
      <div class="ps-section--offer">
        <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img src="{{url('marketplace')}}/images/banner/home-banner-1.png" alt=""></a></div>
        <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img src="{{url('marketplace')}}/images/banner/home-banner-2.png" alt=""></a></div>
      </div>
          ...
          <div class="ps-section__content">
            <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="30" data-owl-nav="false" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="1" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-duration="1000" data-owl-mousedrag="on">
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{url('marketplace')}}/images/shoe/1.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{url('marketplace')}}/images/shoe/2.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/3.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/4.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/5.jpg" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{url('marketplace')}}/images/shoe/3.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{url('marketplace')}}/images/shoe/2.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/3.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/4.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/5.jpg" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{url('marketplace')}}/images/shoe/4.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{url('marketplace')}}/images/shoe/2.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/3.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/4.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/5.jpg" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{url('marketplace')}}/images/shoe/5.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{url('marketplace')}}/images/shoe/2.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/3.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/4.jpg" alt=""><img src="{{url('marketplace')}}/images/shoe/5.jpg" alt=""></div>
      ...
      <div class="ps-home-testimonial bg--parallax pb-80" data-background="{{url('marketplace')}}/images/background/parallax.jpg">
        <div class="container">
          <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on" data-owl-animate-in="fadeIn" data-owl-animate-out="fadeOut">
            <div class="ps-testimonial">
              <div class="ps-testimonial__thumbnail"><img src="{{url('marketplace')}}/images/testimonial/1.jpg" alt=""><i class="fa fa-quote-left"></i></div>
              <header>
            ...
            <div class="ps-testimonial">
              <div class="ps-testimonial__thumbnail"><img src="{{url('marketplace')}}/images/testimonial/2.jpg" alt=""><i class="fa fa-quote-left"></i></div>
              <header>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
            ...
            <div class="ps-testimonial">
              <div class="ps-testimonial__thumbnail"><img src="{{url('marketplace')}}/images/testimonial/3.jpg" alt=""><i class="fa fa-quote-left"></i></div>
              <header>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
          ...
          <div class="ps-section__content">
            <div class="row">
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                      <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{url('marketplace')}}/images/blog/1.jpg" alt=""></div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                      <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{url('marketplace')}}/images/blog/2.jpg" alt=""></div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                      <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{url('marketplace')}}/images/blog/3.jpg" alt=""></div>
